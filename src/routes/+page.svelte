<script>
	...
	async function search() {
		...
		let fullSearchCriteria = `Give me a list of 5 ${location} recommendations ${
			...
			selectedCategories || specificDescriptors
				? `If you do not have 5 recommendations that fit these criteria perfectly, do your best to suggest other ${location}'s that I might like.`
				: ''
		} Please return this response as a numbered list with the ${location}'s title, followed by a colon, and then a brief description of the ${location}. There should be a line of whitespace between each item in the list.`;
